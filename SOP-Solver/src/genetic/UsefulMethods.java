...
/**
 * A util-class that contains methods that are used by both other classes in the
 * package.
 * 
...
public class UsefulMethods {
	...
	/**
	 * Compares two given solutions for the SOP-instance and checks which one is
	 * shorter.
	 * 
	 * @param solution1,
	 *            solution2 given solutions for the SOP-instance given with the
	 *            param matrix which have to be compared.
	 * @param matrix
	 *            an SOP-instance which fits in the pattern of the SOP-instances
	 *            of the TSP-lib.
	 * @return true if solution1 is better or equal than solution2 or if
	 *         solution2 is empty and false otherwise.
	 */
	...
	/**
	 * Calculates the length of the given path based on the distances of the
	 * given matrix. Includes the distance from the starting node (which is not
	 * in the path) to the first node in the path and the distance from the last
	 * node in the path to the destination node (which is not in the path as
	 * well).
	 * 
	 * @param path
	 ...
	 *            an SOP-instance which fits in the pattern of the SOP-instances
	 *            of the TSP-lib.
	 * @return the length of the path which is the combined length of every edge
	 *         between the nodes of the path.
	 */
